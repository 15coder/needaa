...
export default function Navbar({ dark, onToggle }: Props) {
  ...
  const navLink: React.CSSProperties = {
    ...
    color: "var(--tx2)", padding: "8px 14px", borderRadius: 100,
      ...
      <div className="nav-inner">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
          ...
          <a href="#contact"
            ...
            style={{ display: "none", height: 36, padding: "0 18px", fontSize: 14, borderRadius: 100 }}>
            تواصل
          </a>
          ...
          {LINKS.map(l => (
            <button key={l.href}
              ...
              style={{
                ...
                color: "var(--tx1)", padding: "14px 16px", borderRadius: 14,
